...
if (_ownerID == dayz_characterID) then {
	...
	//place box (local)
	_bag = createVehicle ["WeaponHolder_ItemStorageBox",_pos,[], 0, "CAN_COLLIDE"];
	_bag setdir _dir;
	player reveal _bag;
	...
	cutText [localize "str_success_box_retrieve", "PLAIN DOWN"];
} else {
	cutText [localize "str_fail_box_retrieve", "PLAIN DOWN"];
};