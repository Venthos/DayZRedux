...
class CfgBuildingLoot {
	...
	class HeliCrash : Default {
		...
		itemType[] = {
			...
			{"Skin_Uniform1_DZ", "magazine"},
			{"Skin_Sniper1_DZ", "magazine"}
		};
		itemChance[] = {
			0.05,	//ItemGPS
			0.03,	//Binocular_Vector
			0.02,	//M4A1_HWS_GL_camo
			0.02,	//M16A4_ACG
			0.01,	//FN_FAL
			0.01,	//Mk_48_DZ
			0.01,	//ch_minimi
	...
	class BlimpTooCrash : Default {
		...
		itemChance[] = {
			...
			0.7,	//Binocular
			1.0,	//medical
			0.2,	//Skin_Uniform1_DZ
			0.3		//Skin_Camo1_DZ
			};
	};

	class HumCrash : Default {
		zombieChance = 0;
		maxRoaming = 0;
		zombieClass[] = {};
		lootChance = 0;
	...
	class LilBCrash : Default {
		...
		itemChance[] = {
			0.25,	//ItemFlashlightRed
			0.25,	//Binocular
			0.40,	//glock17_EP1
			0.25,	//ItemCompass
			0.25,	//medical
			0.04	//Skin_Sniper1_DZ
		};
	};
...
*/
	...
	class SeaOneDirty_RX : MilitarySpecial {
		...
		minRoaming = 5;
		maxRoaming = 10;
		lootPos[] = {{-1.13477, -17.5664, -4.85953}, {0.75, -17.0322, -5.04782}, {-0.211914, -12.9463, -4.78986}, {-0.172852, -10.0098, -4.68387}, {-0.304688, -5.21582, -4.74634}, {1.16, -20.376, -5.41324}};
	};

	class Klen_Fort_Barracks_USMC : Military {
		zombieClass[] = {};
		zombieChance = 0;
		minRoaming = 0;
		maxRoaming = 0;
