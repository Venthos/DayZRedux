...
class CfgSounds {
	...
	class z_hurting_0 {
		name = "";
		sound[] = {"ca\sounds\Characters\Noises\Damage\vasa-damage-g1-02.wss", 0.1, 1, 50};
		titles[] = {0, ""};
	};
	class z_hurting_w_0 {
		name = "";
		sound[] = {"ca\sounds\Characters\Noises\Damage\banz-damage-g1-04.wss", 0.1, 1, 50};
		titles[] = {0, ""};
	};
};